...
GIFS = (environ.get('GIFS', 'https://telegra.ph/file/c921ca6e3dda797054089.mp4 https://telegra.ph/file/c921ca6e3dda797054089.mp4 https://telegra.ph/file/c921ca6e3dda797054089.mp4')).split()

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin environ.get('ADMINS', '').split()]
